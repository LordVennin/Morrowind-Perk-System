...
----------------------------------------------------------------------
-- medium armor runtime logic
----------------------------------------------------------------------
local function __basepack_initMediumArmor()
local core = require("openmw.core")
local interfaces = require("openmw.interfaces")
local pself = require("openmw.self")
local types = require("openmw.types")
...
__basepack_initMediumArmor()


----------------------------------------------------------------------
-- heavy armor runtime logic
----------------------------------------------------------------------
local function __basepack_initHeavyArmor()
local core = require("openmw.core")
local interfaces = require("openmw.interfaces")
local pself = require("openmw.self")
local types = require("openmw.types")
