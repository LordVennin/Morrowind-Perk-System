return {
    ...
    perks = {
        ...
        },
        {
            ...
            y = 115,
            title = "Bark Splitter",
            description = "Placeholder perk: every stroke remembers the forest, even when the target is wearing steel.",
        },
        {
        ...
        },
        {
            ...
            effectId = "demo_noop",
            minimumSkill = 45,
            requires = { "axe_bark_splitter", "axe_crescent_hook" },
            cost = 1,
            x = 0,
            y = 245,
            title = "Hewer's Heart",
