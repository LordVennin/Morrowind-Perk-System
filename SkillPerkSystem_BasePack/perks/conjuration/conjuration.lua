return {
    ...
    perks = {
        ...
        },
        {
            ...
            x = 480,
            y = 140,
            title = "Voice of Dominion",
            description = "Grants a unique spell that bends both people and creatures to your will for a time.",
        },
        {
        ...
        },
        {
            ...
            description = "Grants a unique spell that turns the walking dead in a wide area, and strengthens your Voice of Dominion.",
        },
        {
